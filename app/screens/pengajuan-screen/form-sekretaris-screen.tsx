...
export interface FormSekretarisScreenProps extends NavigationScreenProps<{}> {
}

export const FormSekretarisScreen: React.FunctionComponent<FormSekretarisScreenProps> = observer((props) => {
    ...
    const simpan = async () => {
      if((description == '') || (fileSekretaris == null)){
        ...
        formData.append("file", {
          uri: fileSekretaris.uri,
          name: 'photo.jpg',
          type: (fileSekretaris.type) ? fileSekretaris.type : "image/jpeg"
        });
        setLoading(true);
    ...
    return (
      <View style={layout.container.general}>
        ...
        <Head type="detail" title={"Pengajuan Akomodasi"} navigation={props.navigation} />
                  ...
                  <View style={{...layout.file_field.container_inside, marginBottom: 20 }}>
                    <View style={{flexDirection:'row'}}>
                      ...
                      <View style={{marginLeft:0.027*deviceWidth}}>
                        <Text style={{...layout.file_field.namefile}}>{(fileSekretaris.name) ? fileSekretaris.name : fileSekretaris.filename}</Text>
                        <Text style={{...layout.file_field.sizefile}}>210 kb</Text>
                      </View>
                    </View>
                    <TouchableOpacity style={{...layout.file_field.button_group}} onPress={deleteFileSekretaris}>

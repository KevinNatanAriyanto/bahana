...
export interface PrivacyScreenProps extends NavigationScreenProps<{}> {
}

export const PrivacyScreen: React.FunctionComponent<PrivacyScreenProps> = observer((props) => {
  const rootStore = useStores()
	...
	const loadAbout = async () => {
		setLoading(true);
		var result = await rootStore.getPrivacy();
		setLoading(false);
  ...
  return (
    <View style={layout.container.general}>
		...
		<ScrollView>
			<Header type="detail" title={"general.privacy"} navigation={props.navigation} />

...
export interface ReportTasksScreenProps extends NavigationScreenProps<{}> {
}

export const ReportTasksScreen: React.FunctionComponent<ReportTasksScreenProps> = observer((props) => {
    ...
    */
    ...
    const stopWorking = async () => {
      ...
      // formData.append("cc_user_id", selectedEndDate); // for cc notif on tasks
      ...
      if(validate){
        ...
        if(result.kind != "ok"){
            ...
            rootStore.pushData('my_queues', {
              ...
              action: 'stopTask',
              will_update: "tasks",
              description: "Selesai bekerja pada tugas",
        ...
        <ScrollView style={layout.container.content_wtabbar}>
          ...
          <View style={{ ...layout.container.wrapper, ...layout.container.bodyView }}>
            ...
            {(task.is_requires_camera == 1 && !rootStore.settings.offline_mode &&
              <View style={{ ...layout.alert.wrapper, ...layout.alert.info_alt }}>
                  <Text style={{ ...layout.alert.text, ...layout.alert.text_info_alt }}>Tugas ini mengharuskan anda untuk mengambil foto untuk pelaporan. </Text>
              </View>
            )}

...
import { TasksScreen, TasksDetailScreen, BriefingDetailScreen, FormTasksScreen, FormBriefingScreen, ReportTasksScreen } from "../screens/tasks-screen"
...
import { MeetingScreen, MeetingDetailScreen, FormMeetingScreen, ReportMeetingScreen } from "../screens/meeting-screen"
import { OtorisasiScreen, OtorisasiRequestScreen } from "../screens/otorisasi-screen"
import { TrackingScreen, TrackingSendScreen, TrackingRequestScreen, TrackingHRDScreen } from "../screens/tracking-screen"

import { FormScreen, FormListScreen, FormDetailScreen, FormHistoryScreen, FormAddScreen, FormApproveScreen } from "../screens/form-screen"

import { BootstrapScreen } from "../screens/bootstrap-screen"
import { ProfileScreen, EditProfileScreen, ChangePasswordScreen, EditLokasiRumahScreen, IframeScreen } from "../screens/profile-screen"
import { MenuScreen } from "../screens/menu-screen"
import { NotesScreen, FormNotesScreen, FormAssigneeScreen } from "../screens/notes-screen"
...
export const PrimaryNavigator = createStackNavigator(
  {
    ...
    otorisasi_request: { screen: OtorisasiRequestScreen },
    tracking: { screen: TrackingScreen },
    tracking_send: { screen: TrackingSendScreen },
    tracking_request: { screen: TrackingRequestScreen },
    tracking_hrd: { screen: TrackingHRDScreen },

    tasks: { screen: TasksScreen },
    form_tasks: { screen: FormTasksScreen },
    form_briefing: { screen: FormBriefingScreen },
    report_tasks: { screen: ReportTasksScreen },
    task_detail: { screen: TasksDetailScreen },
    briefing_detail: { screen: BriefingDetailScreen },

    forms_approve : { screen: FormApproveScreen },
    ...
    form_meeting: { screen: FormMeetingScreen },
    report_meeting: { screen: ReportMeetingScreen },
    meeting_detail: { screen: MeetingDetailScreen },
    ...
    form_notes: { screen: FormNotesScreen },
    form_assignee: { screen: FormAssigneeScreen },
